...
Parse.prototype._readRecord = function () {
  var self = this;
  this.pull(4).then(function (data) {
...
Parse.prototype._readFile = function () {
  var self = this;
  this.pull(26).then(function (data) {
    ...
    return self.pull(vars.fileNameLength).then(function(fileName) {
      ...
      self.pull(vars.extraFieldLength).then(function (extraField) {
        if (vars.compressionMethod === 0) {
          self.pull(vars.compressedSize).then(function (compressedData) {
            if (hasEntryListener) {
          ...
          if (fileSizeKnown) {
            ...
            if (hasEntryListener) {
              ...
              self.stream(vars.compressedSize, inflater).pipe(entry);
            } else {
              self.drain(vars.compressedSize, function (err) {
                if (err) {
...
Parse.prototype._processDataDescriptor = function (entry) {
  var self = this;
  this.pull(16).then(function (data) {
    var vars = binary.parse(data)
...
Parse.prototype._readCentralDirectoryFileHeader = function () {
  var self = this;
  this.pull(42).then(function (data) {
...
Parse.prototype._readEndOfCentralDirectoryRecord = function () {
  var self = this;
  this.pull(18).then(function(data) {
